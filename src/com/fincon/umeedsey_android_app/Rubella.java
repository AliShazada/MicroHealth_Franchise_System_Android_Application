...
public class Rubella extends Activity {

	public static String rslt = "";

	RadioGroup RG_Rubella;
	RadioButton RB_Rubella;
	int ID_rubella;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.rubella);

		setCurrentDateOnView();
		addListenerOnButton();

		RG_Rubella = (RadioGroup) findViewById(R.id.radio_rubella);
		Remarks = (EditText) findViewById(R.id.details_rubella);

		BTN_Save = (Button) findViewById(R.id.save_rubella);
		BTN_Skip = (Button) findViewById(R.id.Skip_rubella);
		...
		BTN_Save.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				ID_rubella = RG_Rubella.getCheckedRadioButtonId();
				RB_Rubella = (RadioButton) findViewById(ID_rubella);

				if (RG_Rubella.getCheckedRadioButtonId() == -1) {
					Toast.makeText(Rubella.this,
				...
				if (result == 2) {
					Toast.makeText(Rubella.this, "Invalid Date ! ..",
							Toast.LENGTH_SHORT).show();
					Validator = 11;
				}
				...
				if (Validator != 11) {
					...
					DashBoardSession.setRubellaTitre(11);

					Intent i = new Intent(Rubella.this, DashBoard.class);
					startActivity(i);
				}
			}
		});
		...
		BTN_Skip.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Toast.makeText(Rubella.this, "Skipped !..." + rslt,
						Toast.LENGTH_SHORT).show();
	...
	public void setCurrentDateOnView() {
		...
		tvDisplayDate = (EditText) findViewById(R.id.editText_TestDate_rubella);
	...
	public void addListenerOnButton() {
		...
		btnChangeDate = (Button) findViewById(R.id.button_add_TestDate_rubella);
